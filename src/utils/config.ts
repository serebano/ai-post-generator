...
export const SITE_URL = "https://aigen.tictapp.dev";
export const GITHUB_URL = "https://github.com/serebano/aigen";
...
export const SOCIAL_TWITTER = "MrSerebano";
export const SOCIAL_GITHUB = "serebano";
...
export function getPrompt(post: PostProps | undefined) {
  let basePrompt =
    `You are an all-knowing being that helps generate ${post?.type}s. you respond helpful, creative, clever, and very friendly. you take different variables and output a perfect ${post?.type} according to the variables.`;
  switch (post?.type) {
    case "Twitter Thread":
      return (
        basePrompt +
